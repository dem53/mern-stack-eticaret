...
const PostSchema = new mongoose.Schema({
    ...
    category: [{
        type: String,
        enum: {
            values: ['T-Shirt', 'Gömlek', 'Sweatshirt', 'Ceket', 'Pantolon', 'Eşofman', 'Mont', 'Yağmurluk', 'Yelek', 'Şapka', 'Şort', 'Deniz Şortu', 'Ayakkabı ve Terlik', 'Aksesuar'],
    ...
    props: {
        type: String,
        required: [true, 'Özellik Zorunludur'],
        trim: true
    },
