...
const createPosts = async (req, res) => {
    try {
        const { name, description, price, stock, category, tags, brand, color, size, tittle, props, selling } = req.body;

        // Zorunlu alanları kontrol et
        if (!name || !description || !price || !stock || !category || !brand || !color || !size || !tittle || !props) {
