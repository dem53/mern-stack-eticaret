...
function SepetimContent({ cartItems, onAddToCart, onRemoveFromCart, onClearCart, setIsCartOpen }) {
    ...
    return (
        <div className="bg-white container mx-auto p-4 flex flex-col justify-center">
            <div className='mt-20 bg-gray-100 text-black py-4 px-4'>
                <div className='flex w-full flex-row my-1 justify-between items-center'>
                    <div>
                                ...
                                <div key={index} className="flex items-start justify-between border-b pb-4">
                                    ...
                                    <div className='flex flex-col gap-4 items-end'>
                                        ...
                                        <div className='flex flex-row items-center gap-6 justify-center'>
                                            ...
                                            <div className='flex flex-col items-center justify-center gap-2'>
                                                <h1 className='font-sans font-semibold underline text-xs'>Beden</h1>
                                                <h2 className='raleway text-xs text-gray-700'>{item.size}</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="carousel-wrapper mt-8 mb-20 container mx-auto">
