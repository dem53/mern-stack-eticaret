...
function Header({ user, setUser, cartItemCount }) {
  ...
  return (
    ...
    <header className='absolute w-full border-opacity-50 border-black z-50 bg-opacity-90'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='relative'>
                ...
                <div className=' bg-red-600 px-1 rounded-full font-sans text-white text-xs absolute z-50 -bottom-3 -right-2'>{favorites}</div>
              </div>
