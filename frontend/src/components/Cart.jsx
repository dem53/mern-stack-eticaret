                        ...
                        {Array.isArray(cartItems) && cartItems.map((item, index) => (
                            <div key={index} className="flex items-center justify-between border-b pb-3">
                                <div className="flex items-center gap-4">
                                    ...
                                    />
                                    <div>
                                        <h3 className="font-semibold text-sm raleway">{item.product.name}</h3>
                                        <p className="text-xs text-gray-500 font-semibold">{item.product.brand}</p>
                                        <p className="text-xs text-gray-500 font-semibold">{item.size}</p>
