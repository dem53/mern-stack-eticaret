            ...
            <div className="w-full flex flex-col xl:flex-row justify-around p-5 gap-8 bg-gray-50 rounded-lg">
                ...
                <div className="flex flex-col w-full p-5">
                    ...
                    {paymentStep && contactInfo.paymentMethod === 'bank_transfer' && (
                        ...
                        <div className='flex flex-col bg-white rounded-md shadow-lg items-start justify-start'>
                            <h3 className="text-2xl font-bold tracking-wide font-sans mb-4">Havale / EFT Ödeme Bilgileri</h3>


                            <div className='flex flex-col my-2 items-start justify-start'>
                                <div className='font sans font-medium text-sm flex flex-col items-start px-4 font-xs my-4 text-black transform ease-in-out'>
                                    <h1>
                                        Not: Lütfen ödemenizi yaptıktan sonra havale formunu doldurunuz.
                                    </h1>
                                    <div className='flex flex-col items-start shadow-2xl'>
                                        <HavaleBox
                                            tittle={'Ödemenizi yaparken açıklama kısmını AD-SOYAD yazmanız ricada bulunulur.'}
                                            bankName={'Akbank'}
                                            names={'LA PANDİA Satış Hizmetleri Ltd'}
                                            ıban={'TR 340003043040304030430430'}
                                            hesapNo={'05372422'}
                                            subeNo={'0043'}

                                        />
                                        <p className=' mt-8 gap-2'><span className='font-sans text-2xl font-extrabold'> </span><span className='text-lg text-emerald-500'>{formatTurkishLira(totalAmount)}</span></p>
                                    </div>
                            ...
                            <div className='flex items-center px-2 justify-between w-full gap-4'>
                                ...
                                <button
                                    ...
                                    className="bg-red-500 text-white rounded-md text-xs py-1 p-1 px-3 mt-3"
                                    style={{
                                        fontSize: '10px'
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    className="bg-emerald-500 text-white rounded-md p-1 py-1 px-3 mt-3"
                                    style={{
                                        fontSize: '10px'
                                    }}
                                >
                                ...
                                {cartItems.map((item) => (
                                    <div key={item.product._id} className="flex justify-between">
                                        <div className="flex items-center">
                                            <img
                                                src={`http://localhost:8000${item.product.imageUrls[0]}`}
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className='raleway mt-1 text-xs'>{item.size}</p>
