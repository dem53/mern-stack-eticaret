...
import '../App.css'
import Banner3 from '../images/img14.jpeg';
import Banner4 from '../images/banner-img-1.webp';
import Banner1 from '../images/tshirt-bg.avif';
...
function Main() {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:8000/api/abone/add', {
                name,
                lastname,
                phone,
                email,
    ...
    return (
        <div className="h-full w-full">
            <div className="w-full flex flex-col justify-between items-center">
                                        ...
                                        >
                                                ...
                                                >
                                                    {product.imageUrls && product.imageUrls.length > 0 ? (
                                                        <div className="relative w-full h-full">
                                                            <img
                                                                src={`http://localhost:8000${product.imageUrls[0]}`}
                                                                alt={product.name}
                                                                className="w-80 h-80 object-cover transition-all duration-500 ease-in-out transform "
                                                                onError={(e) => {
                                                            ...
                                                            {product.imageUrls[1] && (
                                                                <img
                                                                    src={`http://localhost:8000${product.imageUrls[1]}`}
                                                                    alt="Second Image"
                                            ...
                                            <div className="flex flex-col p-4 gap-2">
                                                ...
                                                <span className='flex flex-col items-start justify-center gap-1'>
                                                    <span className="text-xs text-gray-800 text-opacity-55 font-semibold line-through  ">
                                                        {formatTurkishLira((product.price / 6) + (product.price))}
                                                    </span>
                                                    <span className="text-sm font-extrabold text-shadow shadow-white shadow-lg text-black">
                ...
                <div className="banner cursor-pointer w-full my-4 flex items-center justify-center banner-2 h-screen">
                    <div className="montserrat text-5xl lg:text-5xl xl:text-7xl text-white text-center">
                        <h1>T-SHİRT</h1>
                    </div>
                </div>

                <div className="banner cursor-pointer my-4 w-full flex items-center justify-center banner-4 h-screen">
                    <div className="montserrat text-5xl text-center lg:text-5xl xl:text-7xl text-white ">
                        <h1>SWEATSHIRTS</h1>
                    </div>
                </div>

                <div className="banner cursor-pointer my-4 w-full flex items-center justify-center banner-5 h-screen">
                    <div className="montserrat text-5xl text-center lg:text-5xl xl:text-7xl text-white ">
                        <h1>PANTS</h1>
                    </div>
                </div>
                ...
                <div className="banner cursor-pointer w-full my-4 flex items-center justify-center banner-1 h-screen">
                    <div className="montserrat text-5xl lg:text-5xl xl:text-7xl text-white text-center">
                        <h1>HOODİES</h1>
                    </div>
                </div>
                ...
                <div className="banner cursor-pointer my-4 w-full flex items-center justify-center banner-3 h-screen">
                    <div className="montserrat text-5xl lg:text-5xl xl:text-7xl text-white text-center">
                        <h1>WINDBREAKER</h1>
                    </div>
                </div>
                ...
                <div className='w-full h-[10rem] lg:h-[20rem] bg-gray-300/80 my-12 flex items-center justify-center '>
                    <div className='h-full flex items-center justify-center scroll-wrapper w-full'>
                        ...
                        <div className='font-semibold text-3xl md:text-5xl xl:text-7xl  gap-6 tracking-widest text-black uppercase scroll-text'>
                            <span> LA PANDİA - simple, stylish and useful global products -  Pamper yourself you are worth it.</span>
                            <span> LA PANDİA - simple, stylish and useful global products -  Pamper yourself you are worth it.</span>
                            <span> LA PANDİA - simple, stylish and useful global products -  pamper yourself you are worth it.</span>
                            <span> LA PANDİA - simple, stylish and useful global products -  pamper yourself you are worth it.</span>
                            <span> LA PANDİA - simple, stylish and useful global products -  pamper yourself you are worth it.</span>
