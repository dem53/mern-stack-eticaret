...
const UrunEkleModal = ({ isOpen, onClose, onAdd }) => {
    ...
    const handleChange = (e) => {
        ...
        setNewPost(prev => ({ ...prev, [name]: type === 'checkbox' ? checked : value }));
    };
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 z-10 w-11/12 md:w-2/3 lg:w-1/3">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <label className="block text-xs font-medium mb-1">Alt Başlık *</label>
                        <input
                            type="text"
                            name="tittle"
                    ...
                    <div className="mb-4">
                        <label className="block text-xs font-medium mb-1">Özellik *</label>
                        <input
                            type="text"
                            name="props"
                            value={newPost.props}
