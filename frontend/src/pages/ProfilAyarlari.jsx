...
const ProfilAyarlari = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`http://localhost:8000/user/${userId}`, updatedData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`http://localhost:8000/user/${userId}/change-password`, passwordData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
