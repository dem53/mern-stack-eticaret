    ...
    useEffect(() => {
        const fetchPayments = async () => {
            try {
                ...
                const responseHavale = await axios.get('http://localhost:8000/api/odeme/havale/kullanici', {
                    headers: {
                ...
                const responseKredi = await axios.get('http://localhost:8000/api/payment/kullanici', {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                    }
